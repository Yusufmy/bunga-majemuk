...
function hitung($pinjaman, $bunga, $priode)
{
    $bunga_bulan = (1 + $bunga / 100);
    $hitung = pow($bunga_bulan, -$priode);
    $hasil = $pinjaman * $hitung;
    return $hasil;
}
            ...
            <div class="card p-5 mt-5 shadow p-3 mb-5 bg-body rounded">
                    ...
                    <div class="container">
                        <div id="navbarNavAltMarkup">
                            <div class="navbar-nav">
                                ...
                                <a class="nav-link active" aria-current="page" href="presenvalue.php">Back</a>
                            </div>
                        </div>
                    </div>
                </nav>
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-9">
                            <div class="card p-2">
                                <p>Jumlah Pinjaman <?php echo format_rupiah($pinjaman) ?></p>
                                <p>Bunga <?php echo $bunga; ?> %</p>
                                <p>Jangka Waktu <?php echo $priode; ?> Bulan</p>
                                <?php
                                $mo = $pinjaman;
                                $furure = hitung($pinjaman, $bunga, $priode);
                                // $hasil = $mo * $furure;
                                echo "Total setelah " . $priode . " bulan yaitu : " . format_rupiah($furure);
                                ?>
                            </div>
                        </div>
                    </div>
