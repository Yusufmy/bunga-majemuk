    ...
    <div class="container">
        <div class="row mt-5 d-flex justify-content-center">
            <div class="col-md-8">
                <div class="card p-5">
                    <div class="card-body">
                        <h2>Bunga Majemuk | Present Value</h2>
                        <form action="present.php" method="POST">
                            <div class="mb-3 mt-3">
                                <label for="modal" class="form-label">Besar Pinjaman: </label>
                                <input type="text" class="form-control" id="modal" name="pinjaman">
                            </div>
                            <div class="mb-3">
                                <label for="rate" class="form-label">Bunga(%): </label>
                                <input type="text" class="form-control" id="rate" name="bunga">
                            </div>
                            <div class="mb-3">
                                <label for="priode" class="form-label">Lama Pinjaman(bulan): </label>
                                <input type="text" class="form-control" id="priode" name="priode">
                            </div>
